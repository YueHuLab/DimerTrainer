...
class DimerAdamWOptimizer(torch.optim.Optimizer):
    def __init__(self, params, lr=1e-3, beta1=0.9, beta2=0.999, eps=1e-8, 
                 weight_decay=1e-2, dimer_strength=0.1, rotation_interval=10, rotation_lr=0.1,
                 displacement=1e-4, base_optimizer='adamw', verbose_logging=False):
        ...
        super(DimerAdamWOptimizer, self).__init__(params, defaults)
        ...
        logger.info(f"[DimerOptimizerAdamW] Initialized with base: {self.base_optimizer.upper()}")
